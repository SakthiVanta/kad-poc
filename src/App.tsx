...
import { LayoutDashboard, Map, Plus, Wallet, Settings as SettingsIcon, LogOut } from 'lucide-react';
    ...
    <Router>
      <div className="flex min-h-screen bg-surface w-full overflow-x-hidden">
        ...
        <div className="flex-1 lg:ml-64 flex flex-col min-w-0 h-screen overflow-y-auto relative text-base">
          ...
          <footer className="hidden lg:block px-10 py-6 border-t border-outline-variant/10 text-center mt-auto flex items-center justify-between">
            ...
            <button 
              onClick={logout}
              className="flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors text-[10px] font-bold uppercase tracking-[0.2em]"
            >
              <LogOut size={14} />
              Logout
            </button>
